...
J'observe que les alimentations ÀPasCher(TM) ont souvent une tension assez "moche" au démarrage et à l'arrêt. Au lieu de monter très rapidement à leur tension nominale et de redescendre très rapidement à zéro, elles augmentent lentement.
Cela a pour effet, tout à fait non souhaité mais tout à fait sympathique, de faire une gradation (*fade in*) de la lumière à l'allumage, et à l'extinction. Cet effet est observé lorsqu'on commute l'entrée de l'alimentation, soit avec l'interrupteur physique du montage d'origine, soit en mettant en place la détection de présence avec commutation AC.

C'est plutôt une marque de mauvaise qualité de l'alimentation, mais j'aime bien cet effet, et on ne l'observe pas en commutation DC, où au contraire l'allumage et l'extinction sont francs.

## Comment reproduire cet effet ?

Revenons en classe de terminale scientifique quelques instants et posons-nous la question : comment créer cet effet ?
On souhaite retarder la montée de la tension, en suivant une courbe qui correspond à une exponentielle... on peut faire cela avec un circuit RC ! 
En réalité, le défaut de l'alimentation qui fait cet effet est précisément lié aux condensateurs d'entrée et de sortie à l'intérieur de cette alimentation. On peut rajouter une capacité en sortie, de telle sorte que lorsque le transistor commute, il charge un condensateur (qui va donc lentement passer de 0V à 12V), et brancher les LED en parallèle sur ce condensateur afin qu'elles mêmes soient exposées à la montée en douceur de la tension.
(Note : il s'agit strictement d'un effet visuel et il n'y a aucune justification de sécurité ou de durabilité des LED derrière cette amélioration.)
